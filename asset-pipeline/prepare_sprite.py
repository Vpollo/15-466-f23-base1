...
if __name__ == "__main__":
    ...
    sprite_dir = '../sprites/'
    sprite_runtime_dir = '../sprites-runtime/'
    for png in os.listdir(sprite_dir):
        if png[-3:] == 'png':
            write_sprite_to_binary(sprite_dir + png, sprite_runtime_dir + png[:-4] + '.bin')
            print(png + ' .......... OK')
